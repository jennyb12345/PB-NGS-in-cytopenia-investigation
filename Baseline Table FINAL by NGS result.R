# ============================================================
# TABLE BY PB NGS OUTCOME (Pos vs Neg)
# ============================================================
...
tbl_ngs <- df %>%
  ...
  tbl_summary(
    ...
    label = list(
      ...
      dx_myeloid ~ "Myeloid",
      dx_lymphoid ~ "Lymphoid",
      dx_non_haem ~ "Non-Haematological",
      wbc ~ "WBC",
      hb ~ "Hb",
      plts ~ "Plts",
      neuts ~ "Neuts",
...
tbl_ngs
save_as_docx(
  as_flex_table(tbl_ngs),
  path = "Table_by_PB_NGS_outcome_with_3_diagnosis_lines.docx"
)

cat("\nDone.\nFile created:\n- Table_by_PB_NGS_outcome_with_3_diagnosis_lines.docx\n")